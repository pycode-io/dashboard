                                        ...
                                        <a href="{{ route('users.index') }}" class="text-white">
                                            <div class="card-body">
                                                <div class="mb-4">
                                                    ...
                                                    <h4 class="font-weight-medium font-size-24">50<i class="mdi mdi-arrow-up text-success ml-2"></i></h4>
                                                </div>
                                                <div class="pt-2">
                                        ...
                                        <a href="#" class="text-white">
                                            <div class="card-body">
                                                <div class="mb-4">
                                                    ...
                                                    <h4 class="font-weight-medium font-size-24">15 <i class="mdi mdi-arrow-up text-success ml-2"></i></h4>
                                                </div>
                                                <div class="pt-2">
                                                    <div class="float-right">
                                                        <a href="#" class="text-white-50"><i class="mdi mdi-arrow-right h5"></i></a>
